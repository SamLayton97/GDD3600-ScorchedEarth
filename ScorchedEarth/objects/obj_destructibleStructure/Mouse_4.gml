...
// if no UI messages are present, blocking player's view
if !instance_exists(obj_UIMessage)
{
	// if enemy has not seized structure, player hasn't retreated
	if !isCaptured and !obj_gameManager.playerRetreated and !instance_exists(obj_UIMessage)
	{
